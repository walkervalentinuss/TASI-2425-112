# OLID Classification with mBERT (Token already saved) with Emoji Description in English
...
## Load Tokenized Data
train_df = pd.read_csv("dataset-english/OLID/TTVWE/no_emoji_train_mbert.csv")
val_df = pd.read_csv("dataset-english/OLID/TTVWE/no_emoji_val_mbert.csv")
test_df = pd.read_csv("dataset-english/OLID/TTVWE/no_emoji_test_mbert.csv")
...
loss_df.to_csv("model/olid_mbert_loss_history.csv", index=False)
