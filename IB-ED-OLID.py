# OLID Classification with IndoBERT-lite-base-p1 (Token already saved) with Emoji Description
...
## Load Tokenized Data
train_df = pd.read_csv("dataset/OLID/TTVED/with_emoji_train.csv")
val_df = pd.read_csv("dataset/OLID/TTVED/with_emoji_val.csv")
test_df = pd.read_csv("dataset/OLID/TTVED/with_emoji_test.csv")
