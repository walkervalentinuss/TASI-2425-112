# TweetEval Classification with IndoBERT-lite-base-p1 (Token already saved) no Emoji Description in English
...
## Load Tokenized Data
train_df = pd.read_csv("dataset-english/TwEv/TTVWE/no_emoji_train.csv")
val_df = pd.read_csv("dataset-english/TwEv/TTVWE/no_emoji_val.csv")
test_df = pd.read_csv("dataset-english/TwEv/TTVWE/no_emoji_test.csv")
