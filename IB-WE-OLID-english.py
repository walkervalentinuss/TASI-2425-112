# OLID Classification with IndoBERT-lite-base-p1 (Token already saved) no Emoji Description in English
...
## Load Tokenized Data
train_df = pd.read_csv("dataset-english/OLID/TTVWE/no_emoji_train.csv")
val_df = pd.read_csv("dataset-english/OLID/TTVWE/no_emoji_val.csv")
test_df = pd.read_csv("dataset-english/OLID/TTVWE/no_emoji_test.csv")
...
loss_df.to_csv("model/olid_indobert_loss_history.csv", index=False)
